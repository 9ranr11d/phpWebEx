...
<?php
	...
	$content    = $row["content"];		
?>
	    <form  name="board_form" method="post" action="record_modify.php?num=<?=$num?>&page=<?=$page?>" enctype="multipart/form-data">
	    	 <ul id="board_form">
				<li>
	    		...
	    		<li>
	    			<ul>
						<li><span><input name="subject" type="radio" value="등" checked>등</span></li>	<!-- 수정시에도 종목은 radio로 받는다-->
